    ...
    <div id="wrapper">
            ...
            <div class="container">
                ...
                <nav>
                    <ul>
                        ...
                        <li class="nav-cha">
                            <a href="../hang.php?page=hang">Thực đơn</a>
                            <ul class="nav-con">
                                <?php
                                $sql = "SELECT * FROM category";
                                $result = executeResult($sql);
                                foreach ($result as $item) {
                                    echo '<li><a href="../hang.php?id_category=' . $item['id'] . '">' . $item['name'] . '</a></li>';
                                }
                                ?>
                            </ul>
                        </li>
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            try {
                ...
                $nguoigui = 'qtien2109@gmail.com'; // Tài khoản Email
                $matkhau = 'Tienphan2109'; // Mật khẩu Email
                $mail->SMTPSecure = 'ssl';  // encryption TLS/SSL 
                $mail->Port = 465;  // Port kết nối: khai báo 465 hoặc 587                


                // Recipients - Người nhận
                $tennguoigui = 'Phan Quang Tiến'; // Tên người gửi lấy từ form nhập
                $mail->Username = $nguoigui; // SMTP username
                $mail->Password = $matkhau;   // SMTP password
                $mail->setFrom($nguoigui, $tennguoigui); //mail và tên người nhận 
                $to = $email; // Email cần gửi đến lấy từ form nhập
                $to_name = "Phan Quang Tiến"; // Tên người cần gửi đến
