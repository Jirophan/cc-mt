...
<body>
    ...
    <form method="POST" action="">
        ...
        <div class="form-group">
            ...
            <input type="email" name="subject" required="required" />
        </div>
        <div class="form-group">
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        try {
            ...
            $mail->addAddress("qtien2109@gmail.com");               


            // Recipients - Người nhận
            $tennguoigui = $name; // Tên người gửi lấy từ form nhập
            $mail->Username = "testdc999@gmail.com"; // SMTP username
            $mail->Password = 'dfvpbalbwtbvgrrq';   // SMTP password
