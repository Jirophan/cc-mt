...
<main>
    <div class="container">
        ...
        <section class="main">
            ...
            switch ($page) {
                case "hang":
                    require('menu-con/nike.php');
                    require('menu-con/adidas.php');
                    require('menu-con/puma.php');
                    require('menu-con/vans.php');
                    require('menu-con/converse.php');
                    require('menu-con/balenciaga.php');
                    break;
                default:
                    break;
            }
